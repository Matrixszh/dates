          ...
          <div ref={heroRef} className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className={`text-center lg:text-left order-2 lg:order-1 ${heroVisible ? '' : 'opacity-0'}`}>
              ...
              <h1 className={`text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight mb-6 ${heroVisible ? 'fade-in-up stagger-1' : ''}`}>
                <span className="shimmer-text" style={{ fontFamily: "'Rakkas', cursive" }}>TAMR</span>
                <br />
                <span className="text-brown-700" style={{ fontFamily: "'Rakkas', cursive" }}>Premium Dates</span>
              </h1>
      ...
      <footer className="bg-gradient-to-b from-brown-800 to-brown-900 text-cream-200 py-16 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            {/* Contact */}
            <div>
              <h4 className="text-xl font-semibold text-gold-400 mb-6" style={{ fontFamily: "'sabana', serif" }}>Contact Us</h4>
